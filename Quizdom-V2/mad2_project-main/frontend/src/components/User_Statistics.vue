<template>
  <div class="bg-pastel min-vh-100">
    <!--
      Back button in top-left corner to return to user dashboard
    -->
    <div class="d-flex justify-content-start">
      <router-link to="/user" class="btn text-white fw-bold shadow-3d rounded px-3 py-1">⬅︎ BACK</router-link>
    </div>

    <div class="container py-4">
      <!-- Page Heading -->
      <h2 class="text-center text-white fw-bold mb-5">U S E R - S T A T S</h2>
      <div class="row justify-content-center g-4">
        <!-- Bar Chart Card: User's Top Scores by Subject -->
        <div class="col-12 col-md-6">
          <div class="card shadow-sm h-100">
            <div class="card-body">
              <h3 class="card-title text-center fs-5 mb-4">Your Top Scores by Subject (All-Time)</h3>
        ...
        <!-- Pie Chart Card: User's Quiz Attempts by Subject -->
        <div class="col-12 col-md-6">
          <div class="card shadow-sm h-100">
            <div class="card-body">
              <h3 class="card-title text-center fs-5 mb-4">Your Total Quiz Attempts by Subject</h3>
              <div class="d-flex justify-content-center">
                <div style="width: 300px; height: 300px; position: relative;">
...
<style scoped>
/*
  Background gradients for the user stats page.
*/
.bg-misty {
    ...
    setup() {
        ...
        const baroptions = ref({
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'All-Time Highest Scores Achieved by You per Subject (Across All Quizzes)',
                },
            },
        });
        // Pie chart options
        const pieOptions = ref({
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Total Number of Quiz Attempts Made by You per Subject',
                },
            },
        });
        ...
        onMounted(async() => {
            const response = await fetch('http://127.0.0.1:5000/user_stats', {
                method: 'GET',
                headers: {
